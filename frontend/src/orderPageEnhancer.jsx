...
function isAdmin() { return window.dayuCurrentUser?.role === "ADMIN"; }

function ensureFinanceMenu(){
  const existing=findMenu("Keuangan");
  if(!isAdmin()){
    existing?.remove();
    if(activePage==="Keuangan") openDashboard();
    return;
  }
